...
class StaffCurveNabBar extends StatefulWidget {
  final int initialIndex;
  const StaffCurveNabBar({super.key, this.initialIndex =2});

  @override
  State<StaffCurveNabBar> createState() => _StaffCurveNabBarState();
}

class _StaffCurveNabBarState extends State<StaffCurveNabBar> with TickerProviderStateMixin {
  int _currentIndex = 2;
