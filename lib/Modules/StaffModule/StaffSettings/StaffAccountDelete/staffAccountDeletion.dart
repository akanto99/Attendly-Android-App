...
import 'package:c9_app/Modules/StaffModule/StaffSettings/StaffAccountDelete/staffConfirmDelete.dart';
...
class DeleteAccountStaff extends StatefulWidget {
  final String clientemails;
  const DeleteAccountStaff({super.key,required this.clientemails});

  @override
  State<DeleteAccountStaff> createState() => _DeleteAccountStaffState();
}

class _DeleteAccountStaffState extends State<DeleteAccountStaff> {
      ...
      if (response.statusCode == 200) {
        ...
        Future.delayed(Duration(seconds: 2), () {
          Navigator.push(
            context,
            MaterialPageRoute(
              builder: (context) => ConfirmDeleteStaff(),
            ),
          );
        });
        print('Account Deletion Successful');
