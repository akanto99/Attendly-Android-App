...
import 'package:c9_app/Modules/StaffModule/StaffSettings/StaffAccountDelete/staffAccountDeletion.dart';
import 'package:c9_app/Modules/StaffModule/StaffSettings/staffChangePassword.dart';
...
class PermissonSettingsScreen extends StatefulWidget {
  final String passEmail;
  const PermissonSettingsScreen({super.key,required this.passEmail});

  @override
  State<PermissonSettingsScreen> createState() => _PermissonSettingsScreenState();
}

class _PermissonSettingsScreenState extends State<PermissonSettingsScreen> {
  @override
  ...
  Widget permissionTile({
    ...
    return ListTile(
      ...
      title: Text(title),
      subtitle: Text("Status of the Permission"),
      onTap: () async {
  ...
  Widget ChangePasswordContainer({
    ...
    return GestureDetector(
      onTap: (){
        ...
        Navigator.push(context, MaterialPageRoute(builder: (context)=>StaffChangePassword(staffemails:selectedEmail)));
      },
      child: Container(
        padding: EdgeInsets.all(10),
        margin: EdgeInsets.symmetric(horizontal: 10, vertical: 5),
            ...
            Row(
              children: [
                ...
                Column(
                  ...
                  children: [
                    Text(
                      title,style: TextStyle(fontWeight: FontWeight.w400,fontSize: 18),
                    ),
                    Text(subtitle),
                  ],
                ),
  ...
  Widget AccountDeleteContainer({
    ...
    return GestureDetector(
      onTap: (){
        final selectedEmail= '${widget.passEmail}';
        Navigator.push(context, MaterialPageRoute(builder: (context)=>DeleteAccountStaff(clientemails:selectedEmail)));
      },
      child: Container(
        padding: EdgeInsets.all(10),
        margin: EdgeInsets.symmetric(horizontal: 10, vertical: 5),
