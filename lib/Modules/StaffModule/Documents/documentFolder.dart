...
class DocViewFolder extends StatefulWidget {
  const DocViewFolder({Key? key}) : super(key: key);

  @override
  State<DocViewFolder> createState() => _DocViewFolderState();
}

class _DocViewFolderState extends State<DocViewFolder>with WidgetsBindingObserver{
