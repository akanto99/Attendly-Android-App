...
class AboutUsClient extends StatefulWidget {
  const AboutUsClient({super.key});

  @override
  State<AboutUsClient> createState() => _AboutUsClientState();
}

class _AboutUsClientState extends State<AboutUsClient> {
  String _urlins = "";
  String _urlfb ="";
  String _urllinks = "";
              ...
              children: [
                ...
                Theme(
                  ...
                  child: ExpansionTile(
                    ...
                    title: Text("What does C9 Recruitment company do?", style: TextStyle(fontSize: 16, fontWeight: FontWeight.w400),),
                    children: <Widget>[
                      Padding(
                ...
                Theme(
                  ...
                  child: ExpansionTile(
                    ...
                    title: Text("What services does C9 Technology offer?", style: TextStyle(fontSize: 16, fontWeight: FontWeight.w400),),
                    children: <Widget>[
                      Padding(
                          padding: const EdgeInsets.symmetric(horizontal: 16.0),
                          child: Align(
                ...
                Theme(
                  ...
                  child: ExpansionTile(
                    ...
                    title: Text("Why is C9 Recruitment suitable for you?", style: TextStyle(fontSize: 16, fontWeight: FontWeight.w400),),
                    children: <Widget>[
                      Padding(
                          padding: const EdgeInsets.symmetric(horizontal: 16.0),
                          child: Align(
