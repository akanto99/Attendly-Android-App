...
class SendAfeedBack extends StatefulWidget {
  const SendAfeedBack({super.key});

  @override
  State<SendAfeedBack> createState() => _SendAfeedBackState();
}

class _SendAfeedBackState extends State<SendAfeedBack> {
  int _selectedStar = 0;
    ...
    return Column(
      ...
      children: [
        ...
        GestureDetector(
          ...
          //   await sendFeedBack();
          // },
          // onTap: (_selectedStar > 0 && _selectedFeedbacks.isNotEmpty)
          //     ? () async {
          //   await sendFeedBack();
          // }
          //     : null,
